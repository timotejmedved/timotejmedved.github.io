  ...
  return (
    <div class="container mx-auto px-4 pb-60 pt-20">
      ...
      <div class="w-full md:w-2/3 md:max-w-full mx-auto">
        <div class="p-1">
          <h1 class="font-semibold text-4xl ">O meni</h1>
        </div>
        <div class="p-3">

          <p class="opacity-80 icon-color font-sans">
      ...
      <div class="w-full md:w-2/3 md:max-w-full mx-auto">
        <div class="p-1">
          <h1 class="font-semibold text-4xl ">Izobraževanje</h1>
        </div>
        <div class="p-3">

          <ul class="list-disc opacity-80 p-3 icon-color font-semibold">
      ...
      <div class="w-full md:w-2/3 md:max-w-full mx-auto">
        <div class="p-1">
          <h1 class="font-semibold text-4xl ">Erasmus+</h1>
        </div>
        ...
        <div class="p-3">
          ...
          <p class="opacity-80 icon-color font-sans">
            V letu 2019 sem sodeloval v projektu Erasmus+ z naslovom <span class="font-bold">"Smo mladi, smo radovedni - Evropa prihajamo!"</span>. V okviru projekta sem tri tedne opravljal prakso na Poljskem v mestu Vroclav (Wrocław). Prakso sem opravljal v podjetju Nexwell Engineering.
          </p>

          <div class="w-full md:w-2/3 md:max-w-full mx-auto shadow-xl transition ease-in-out  hover:-translate-y-1 hover:scale-110 duration-300 pt-5">
          <div class="p-1  bg-color">
            <h1 class="text-white font-semibold text-xl">Dnevnik Wrocław</h1>
          </div>
          <div class="bg-gray-100 p-3">

            <p class="opacity-80 icon-color font-sans p-3">Več o moji izkušnji na Erasmus+ si lahko prebereš v mojem dnevniku, ki je nastal v času bivanja na Poljskem.
              <br /><br />
              <a class="text-gray-700 hover:text-color font-semibold block pb-2 text-sm" href="#">Dnevnik Wrocław (.pdf)</a>
            </p>
          ...
          <div class="flex flex-wrap pt-1">
            <img src="https://cufar.si/files/2015/03/erasmus-logo1.png" class="p-3" />
            <img src="https://media.tacdn.com/media/attractions-splice-spp-674x446/07/7a/6a/7f.jpg" class="p-3" />
          </div>
      ...
      <div class="w-full md:w-2/3 md:max-w-full mx-auto">
        <div class="p-1">
          <h1 class="font-semibold text-4xl uppercase">V medijih</h1>
        </div>
        <div class="p-3">
          <h3 class="icon-color text-xl pb-1">ŠTAJERSKI TEDNIK</h3>
          <p class="opacity-80 icon-color font-sans">
            ...
            <br /><a class="hover:text-color underline" target="_blank" href="https://www.tednik.si/druzba/21581-niko-timotej-in-dominik-dijaki-z-jasno-vizijo-svoje-prihodnosti">ŠTAJERSKI TEDNIK</a>
          </p>
      ...
      <div class="w-full md:w-2/3 md:max-w-full mx-auto shadow-xl transition ease-in-out  hover:-translate-y-1 hover:scale-110 duration-300 pt-5">
        <div class="p-1  bg-color">
          <h1 class="text-white font-semibold text-xl">Izsek iz članka</h1>
        </div>
        <div class="bg-gray-100 p-3">

          <p class="opacity-80 icon-color font-sans p-3">
      ...
      <div class="w-full md:w-2/3 md:max-w-full mx-auto shadow-xl transition ease-in-out  hover:-translate-y-1 hover:scale-110 duration-300">
        <div class="p-1  bg-color">
          <h1 class="text-white font-semibold text-xl">Ostale informacije</h1>
        </div>
        <div class="bg-gray-100  p-3 icon-color font-semibold">
